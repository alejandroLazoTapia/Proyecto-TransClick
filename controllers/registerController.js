   ...
   $(document).ready(function () {
    ...
    app.controller('Register', function ($scope, $http, $window) {
      ...
      $scope.ButtonClick = function () {
        ...
        var datos = { "id_perfil": 1, "id_doc_type": $scope.typeDocument,  "num_document": $scope.numberDocument, "name": $scope.name, "last_name": $scope.name, "email": $scope.email, "sex": $scope.sex, "birth_date": fechaformat, "password": $scope.password };
